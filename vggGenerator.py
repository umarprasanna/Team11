...
class vggGenerator(keras.utils.Sequence):
    ...
    def __init__(self, list_IDs, data_dir, batch_size=32, dim=(48,48), patch_size= 48, n_channels=1, n_classes=2, shuffle=True):
        self.dim = dim
    ...
    def __data_generation__(self, list_IDs_temp):
        ...
        for i, ID in enumerate(list_IDs_temp):
            ...
            y[i] = mask[start_1 + int(self.patch_size/2), start_2 + int(self.patch_size/2), 0]
        return X.reshape((self.batch_size, *self.dim, 3)), y
